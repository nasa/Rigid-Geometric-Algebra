function [M,W] = wedgedotmat(obj)
% WEDGEDOTMAT Matrix for wedgedot of two multivectors.  Also returns the
% matrix for computing just the wedge.
I = eye(3); J = fliplr(I);
...
% Just the wedge product matrix:
W = [s,            O13,    0,           O13,            O13,   0,             O13,   0;
